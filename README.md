...
<table>
    ...
    <tr>
        <td>박상윤</td>
        <td>
            BGM 메서드 구현, 게임 구현, 주된 MAIN 클래스 구현
        </td>
    </tr>
    <tr>
        <td>강민규</td>
        <td>
            POCKET 메서드 구현, POCKETBATTEL 구현주된 MAIN 클래스 구현
        </td>
    </tr>
    <tr>
        <td>장지오</td>
        <td>
            USER 메서드구현, PLAY 메서드구현, 게임 구현, PPT 제작badge&logo=Oracle&logoColor=white"/>
        </td>
    </tr>
    <tr>
        <td>조가현</td>
        <td>
            유스케이스 작성, 테이블 명세서 작성, 아스키아트 메서드 구현, 게임 구현, PPT 제작
        </td>
    </tr>
</table>
